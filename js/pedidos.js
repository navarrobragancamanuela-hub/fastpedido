...
if (process.env.NODE_ENV === 'development') {
    window.debugPedidos = {
        getEstado: () => ({ ...estadoPedidos }),
        forcarRecarregamento: () => carregarPedidos(),
        simularErro: () => exibirErroCarregamento(new Error('Erro simulado')),
        pararAutoRefresh: () => pararAutoRefresh()
    };
}